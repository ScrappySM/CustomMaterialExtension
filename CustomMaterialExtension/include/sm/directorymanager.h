...
namespace SM {
	...
	public:
		/// <summary>
		/// Gets the replacement for the given key
		/// </summary>
		/// <param name="key">
		/// The key to search for, e.g. `$GAME_DATA`
		/// </param>
		/// <returns>
		...
		/// </summary>
		/// <param name="path">
		/// The path to separate the key from, e.g. `$GAME_DATA/Textures/`
		/// </param>
		/// <returns>
		/// The key from the path, or an empty string if the path does not contain a key.
		/// </returns>
